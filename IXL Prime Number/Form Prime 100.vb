' Name:         frmPrime100.vb
' Solution:     Quiz to decide number between 1 to 100 that is prime or not.
...
Public Class frmPrime100
    ...
    Const intPrimeUpTo As Integer = 100
    ...
    Private Sub frmPrime100_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Me.CenterToScreen()
    ...
    Private Sub frmPrime100_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        frmMain.Close()
    End Sub
End Class